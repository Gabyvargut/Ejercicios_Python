...
## Print a string that is contained in a variable from your script
print(preproInsulin)
...
#The actual molecular weight of human insulin is 5807.63, but the program delivers 6696.42
#because it ignores certain bonds and post-translational processing.
